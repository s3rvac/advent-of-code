...
func TestEvaluateExpressionReturnsCorrectResult(t *testing.T) {
	...
	scenarioEvaluatesToCorrectResult(t, "2 * 3 + (4 * 5)", 26)
	scenarioEvaluatesToCorrectResult(t, "5 + (8 * 3 + 9 + 3 * 4 * 3)", 437)
	scenarioEvaluatesToCorrectResult(t, "5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))", 12240)
	scenarioEvaluatesToCorrectResult(t, "(2 + 4 * 9) * (6 + 9 * 8 + 6) + 7", 6811)
	scenarioEvaluatesToCorrectResult(t, "((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2", 13632)
}
