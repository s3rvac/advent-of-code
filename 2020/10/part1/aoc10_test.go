...
func TestMultiplyOneJoltDiffsWithThreeJoltDiffsReturnsCorrectResultForFirstExampleFromAssignment(t *testing.T) {
	adapterJoltages, _ := parseJoltagesFromString(
		`16
10
15
...
func TestMultiplyOneJoltDiffsWithThreeJoltDiffsReturnsCorrectResultForSecondExampleFromAssignment(t *testing.T) {
	adapterJoltages, _ := parseJoltagesFromString(
		`28
33
18
